/*
 g++ -g -lrt -D_REENTRANT par_pthreads_sort.cpp -o par_pthreads_sort -fopenmp -pthread
 usage: par_pthreads_sort <number of threads> <size>
 <number of threads> must be power of two
 cd Documents/code/sort/pthreads
...
int main (int argc, char** argv) {
	...
	if (error) cout << "ERROR \n ";
		...
		cout << "time seq: " << (stop_s-start_s) << " sec. \n";
		cout << "time par: " << (stop_p-start_p) << " sec. \n";
		}
/*
